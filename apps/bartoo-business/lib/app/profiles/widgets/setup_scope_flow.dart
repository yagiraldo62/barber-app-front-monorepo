import 'package:bartoo/app/locations/widgets/forms/location_form.dart';
...
import 'package:bartoo/app/services/widgets/location_services_form/location_services_form.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      ...
      stepsConfigByType = {
        ...
        CreateProfileStep.members:
            (CreateProfileStep step, SetupScopeController controller) =>
                FlowStepConfig(
                  step: step,
                  title: 'Miembros',
                  stepTitle: 'Gestionar Miembros',
                  svgAsset: "assets/images/svgs/team.svg",
                  build:
                      () =>
                          controller.currentProfile.value?.id != null &&
                                  controller.currentLocation.value?.id != null
                              ? ManageMembers(
                                organizationId:
                                    controller.currentProfile.value!.id!,
                                locationId:
                                    controller.currentLocation.value!.id,
                                onContinue: () => controller.onFinish(),
                              )
                              : const SizedBox(),
                ),
      };

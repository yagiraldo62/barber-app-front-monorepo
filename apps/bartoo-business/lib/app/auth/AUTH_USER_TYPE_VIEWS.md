...
**Path:** `apps/bartoo-business/lib/app/auth/views/widgets/client_app_link.dart`
...
**Path:** `apps/bartoo-business/lib/app/auth/views/no_organization_view.dart`
...
### 3. WrongAppView
**Path:** `apps/bartoo-business/lib/app/auth/views/wrong_app_view.dart`
...
- `apps/bartoo-business/lib/app/auth/views/first_login_intro/first_login_intro_view.dart`

import 'package:bartoo/app/modules/auth/controllers/business_auth_actions_controller.dart';
...
class BusinessAuthBinding extends Bindings {
  ...
  void dependencies() {
    ...
    Get.put<BusinessGuestGuardController>(BusinessGuestGuardController());
  }
}
